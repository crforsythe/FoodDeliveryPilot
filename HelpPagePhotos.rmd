...
##### Grocery Delivery
Grocery delivery is a service that delivers a *single* grocery order to a given location (described below). You place your grocery order via a smartphone app or website. The order will be fulfilled up by a grocery store of your choosing.
